...
public class ArrayList2x<T> implements IList<T> {
    ...
    private T[] array;
    private final int lengthMultiplier=2; // jedyna zmiana w porównaniu do klasy ArrayList1
    private int size=0;

    public ArrayList2x() {
        array=(T[]) new Object[lengthMultiplier]; // tutaj rzutujemy typ generyczny tabelaryczny na obiekt typu Object (wynika to z tego,
